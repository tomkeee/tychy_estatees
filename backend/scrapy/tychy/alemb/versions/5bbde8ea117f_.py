...
Revision ID: 5bbde8ea117f
Revises: 9ec95976f92a
Create Date: 2022-06-18 19:38:51.338511
...
revision = "5bbde8ea117f"
down_revision = "9ec95976f92a"
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('auth_permission_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
    ...
    op.create_table(
        "flats_location",
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        sa.Column("street", sa.BOOLEAN(), autoincrement=False, nullable=True),
        sa.Column("district", sa.BOOLEAN(), autoincrement=False, nullable=True),
        sa.Column(
            "location", sa.VARCHAR(length=3000), autoincrement=False, nullable=True
        ),
        sa.Column("flat_number", sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column(
            "flat_average_price",
        ...
        sa.Column(
            "flat_m2_average_price",
            postgresql.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column("date", sa.DATE(), autoincrement=False, nullable=True),
        sa.PrimaryKeyConstraint("id", name="flats_location_pkey"),
    )
    op.create_table(
        "django_session",
        sa.Column(
