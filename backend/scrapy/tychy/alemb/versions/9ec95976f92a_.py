...
Revision ID: 9ec95976f92a
Revises: d9f37ceb0424
Create Date: 2022-06-12 16:58:46.527375
...
revision = "9ec95976f92a"
down_revision = "d9f37ceb0424"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("street", sa.Boolean(), nullable=True),
        sa.Column("district", sa.Boolean(), nullable=True),
