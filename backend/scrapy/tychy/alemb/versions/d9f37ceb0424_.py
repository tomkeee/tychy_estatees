...
Revision ID: d9f37ceb0424
Revises: 16541e55ebe7
Create Date: 2022-06-12 16:20:13.279195
...
def upgrade():
    ...
    op.add_column(
        "tychy_flat", sa.Column("district", sa.String(length=3000), nullable=True)
    )
    op.add_column(
        "tychy_flat", sa.Column("street", sa.String(length=3000), nullable=True)
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("tychy_flat", "street")
    op.drop_column("tychy_flat", "district")
    op.create_table(
        "django_session",
        sa.Column(
